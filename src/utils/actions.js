...
export function fetchNonProdGTMJsonAction(payload) {
    return {
        payload,
        type: FETCH_NONPROD_GTM_JSON
    }
}

export function fetchGTMJsonAction(payload) {
    return {
        payload,
        type: FETCH_GTM_JSON
    }
...
export function getHealthsRolloutStatusAction(payload) {
    return {
        payload,
        type: GET_HEALTHS_ROLLOUTSTATUS
    }
}

export function getVersionsRolloutStatusAction(payload) {
    return {
        payload,
        type: GET_VERSIONS_ROLLOUTSTATUS
    }
}
